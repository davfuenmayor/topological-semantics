theory operation_negative_infinitary
  imports operation_negative boolean_algebra_infinitary
begin
...
(**DM1, DM2, iDM1, iDM2 & CoPw are equivalent.*)
...
(**An analogous relationship holds for variants DM3/4, though the proof is less trivial.
