theory negation_properties
  imports logical_consequence "../conditions/conditions_relativized"
begin
...
lemma "TNDw \<eta> \<Longrightarrow> TND  \<eta>" nitpick oops (**counterexample*)
lemma "TNDw \<eta> \<Longrightarrow> TNDm \<eta>" unfolding neg by simp
lemma "TNDm \<eta> \<Longrightarrow> TNDw \<eta>" nitpick oops (**counterexample*)
...
lemma "ECQm \<eta> \<Longrightarrow> ECQw \<eta>" nitpick oops (**counterexample*)
...
lemma "ECQ \<eta> \<Longrightarrow> LNC \<eta>" nitpick oops (**counterexample*)
lemma "LNC \<eta> \<Longrightarrow> ECQm \<eta>" nitpick oops (**counterexample*)
...
lemma "CoP0 \<eta> \<Longrightarrow> CoP2 \<eta>" nitpick oops (**counterexample*)
lemma "CoP3 \<eta> \<Longrightarrow> CoP0 \<eta>" oops (*TODO*)
lemma "CoP0 \<eta> \<Longrightarrow> CoP3 \<eta>" nitpick oops (**counterexample*)
...
lemma "CoP1 \<eta> \<Longrightarrow> CoP2 \<eta> \<Longrightarrow> ECQm \<eta>" nitpick oops (**counterexample*) 
lemma "CoP1 \<eta> \<Longrightarrow> CoP2 \<eta> \<Longrightarrow> TNDm \<eta>" nitpick oops (**counterexample*) 
...
lemma "MT0 \<eta> \<Longrightarrow> MT1 \<eta> \<Longrightarrow> MT2 \<eta> \<Longrightarrow> MT3 \<eta> \<Longrightarrow> CoP0 \<eta>" nitpick oops (**counterexample*)
lemma "MT0 \<eta> \<Longrightarrow> MT1 \<eta> \<Longrightarrow> MT2 \<eta> \<Longrightarrow> MT3 \<eta> \<Longrightarrow> ECQm \<eta>" nitpick oops (**counterexample*)
lemma "MT0 \<eta> \<Longrightarrow> MT1 \<eta> \<Longrightarrow> MT2 \<eta> \<Longrightarrow> MT3 \<eta> \<Longrightarrow> TNDm \<eta>" nitpick oops (**counterexample*)
...
lemma "DNI \<eta> \<Longrightarrow> CoP1 \<eta>" nitpick oops (**counterexample*)
lemma CoP1_def2: "CoP1 \<eta> = (CoP0 \<eta> \<and> DNI \<eta>)" unfolding neg cond using subset_char2 by blast
lemma "DNE \<eta> \<Longrightarrow>  CoP2 \<eta>" nitpick oops (**counterexample*)
lemma CoP2_def2: "CoP2 \<eta> = (CoP0 \<eta> \<and> DNE \<eta>)" unfolding neg cond using subset_char1 by blast

(**Explore some non-entailment relations:*)
lemma "DNI \<eta> \<Longrightarrow> DNE \<eta> \<Longrightarrow> CoP0 \<eta>" nitpick oops (**counterexample*)
lemma "DNI \<eta> \<Longrightarrow> DNE \<eta> \<Longrightarrow> TNDm \<eta>" nitpick oops (**counterexample*)
lemma "DNI \<eta> \<Longrightarrow> DNE \<eta> \<Longrightarrow> ECQm \<eta>" nitpick oops (**counterexample*)
lemma "DNI \<eta> \<Longrightarrow> DNE \<eta> \<Longrightarrow> MT0 \<eta>" nitpick oops (**counterexample*)
lemma "DNI \<eta> \<Longrightarrow> DNE \<eta> \<Longrightarrow> MT1 \<eta>" nitpick oops (**counterexample*)
...
lemma "DNI \<eta> \<Longrightarrow> nNORM \<eta>" nitpick oops (**counterexample*) 
lemma "DNE \<eta> \<Longrightarrow> nDNRM \<eta>" nitpick oops (**counterexample*) 
...
lemma "nNORM \<eta> \<Longrightarrow> nDNRM \<eta> \<Longrightarrow> rDNE \<eta>" nitpick oops (**counterexample*)
...
(**Explore some non-entailment relations:*)
lemma "CoP0 \<eta> \<Longrightarrow> nADDI\<^sup>a \<eta> \<Longrightarrow> nMULT\<^sup>b \<eta> \<Longrightarrow> nNORM \<eta> \<Longrightarrow> nDNRM \<eta> \<Longrightarrow> DNI \<eta>" nitpick oops (**counterexample*)
lemma "CoP0 \<eta> \<Longrightarrow> nADDI\<^sup>a \<eta> \<Longrightarrow> nMULT\<^sup>b \<eta> \<Longrightarrow> nNORM \<eta> \<Longrightarrow> nDNRM \<eta> \<Longrightarrow> DNE \<eta>" nitpick oops (**counterexample*) 
...
lemma "lCoP0(\<^bold>\<rightarrow>) \<eta> \<Longrightarrow> lCoP1(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
lemma "lCoP2(\<^bold>\<rightarrow>) \<eta> \<Longrightarrow> lCoP0(\<^bold>\<rightarrow>) \<eta>" unfolding neg conn order by blast
lemma "lCoP0(\<^bold>\<rightarrow>) \<eta> \<Longrightarrow> lCoP2(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
...
lemma "TND \<eta> \<Longrightarrow> lCoP1(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
lemma lCoP2_ECQ: "lCoP2(\<^bold>\<rightarrow>) \<eta> \<Longrightarrow> ECQ \<eta>" unfolding neg conn by (smt (verit) setequ_def subset_def)
lemma "ECQ \<eta> \<Longrightarrow> lCoP2(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
...
lemma "CoP2 \<eta> \<Longrightarrow> DS1(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
lemma "CoP1 \<eta> \<Longrightarrow> DS2(\<^bold>\<rightarrow>) \<eta>" nitpick oops (**counterexample*)
