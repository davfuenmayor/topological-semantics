...
We show a shallow semantical embedding of the logics RmbC-ciw and RmbC*)
...
(**cf*)
lemma "CLOSURE \<C> \<Longrightarrow> cf" nitpick oops
(**ce*)
lemma "CLOSURE \<C> \<Longrightarrow> ce" nitpick oops
(**ciw*)
lemma prop_ciw_a: ciw_a by (simp add: conn)
lemma prop_ciw_b: ciw_b by (simp add: conn svfun_compl_def)
(**ci*)
lemma "CLOSURE \<C> \<Longrightarrow> ci_a" nitpick oops
lemma "CLOSURE \<C> \<Longrightarrow> ci_b" nitpick oops
(**cl*)
lemma "CLOSURE \<C> \<Longrightarrow> cl_a" nitpick oops
lemma "CLOSURE \<C> \<Longrightarrow> cl_b" nitpick oops
(**ca_conj*)
lemma prop_ca_conj_a: "ADDI \<C> \<Longrightarrow> ca_conj_a" unfolding cond by (smt (z3) BA_deMorgan1 BA_deMorgan2 join_def meet_def sdfun_dcompl_def setequ_ext subset_def)
...
(**ca_impl*)
lemma "CLOSURE \<C> \<Longrightarrow> ca_impl_a" nitpick oops
lemma "CLOSURE \<C> \<Longrightarrow> ca_impl_b" nitpick oops
