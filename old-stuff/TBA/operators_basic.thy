...
(**In this section we examine the traditional notion of topological (closure, resp. interior) algebras
...
We also explore the less-known notions of border (cf. 'Rand' @{cite Hausdorff}, 'bord' @{cite Zarycki-1}) and
frontier (aka. 'boundary'; cf. 'Grenze' @{cite Hausdorff}, 'fronti\`ere' @{cite Zarycki-1} @{cite Kuratowski-2})
as studied by Zarycki @{cite Zarycki-1} and define corresponding operations for them.*)
...
(**@{text "\<phi>"} is an interior operator (@{text "\<II>(\<phi>)"}) iff it satisfies conditions 1-4 (cf. @{cite Zarycki-1}
and also @{cite Kuratowski-2}). This characterization is shown consistent by generating a non-trivial model.*)
...
(**@{text "\<phi>"} is a closure operator (@{text "\<CC>(\<phi>)"}) iff it satisfies conditions 1-4 (cf. @{cite Kuratowski-1}
@{cite Kuratowski-2}). This characterization is shown consistent by generating a non-trivial model.*)
...
(**@{text "\<phi>"} is a topological frontier operator (@{text "\<FF>(\<phi>)"}) iff it satisfies conditions 1-4
(cf. @{cite Zarycki-2}). This is also shown consistent by generating a non-trivial model.*)
...
(**@{text "\<phi>"} is a topological border operator (@{text "\<BB>(\<phi>)"}) iff it satisfies conditions 1-3
(cf. @{cite Zarycki-2}). This is also shown consistent.*)
...
lemma PB10: "Br_1 \<phi> \<Longrightarrow> Br_3 \<phi> \<Longrightarrow> Br_10 \<phi>" proof - (**proof automagically generated*)
  assume a1: "Br_3 \<phi>"
  assume a2: "Br_1 \<phi>"
...
(**We define and verify some conversion operators useful to derive border and frontier operators from
...
lemma BC3: "Cl_1b \<phi> \<Longrightarrow> Cl_4 \<phi> \<Longrightarrow> Br_3 (\<B>\<^sub>C \<phi>)" unfolding Br_cl_def Br_3_def dual_def conn by (metis (mono_tags, lifting) Cl_9_def MONO_ADDIb PC9)
