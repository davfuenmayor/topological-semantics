...
(**We can also employ the closure and interior operations to define different sorts of implications.
...
(**In particular, 'strenghening the antecedent' is valid only under certain conditions:*)
