...
(**The derivative conditions overlap partly with Kuratowski closure conditions @{cite Kuratowski-1}.
...
(**We finish this section by introducing the `coherence' operator (Cantor's `Koherenz') as discussed
by Zarycki in @{cite Zarycki-2}. As happens with the derivative operator, the coherence operator cannot
